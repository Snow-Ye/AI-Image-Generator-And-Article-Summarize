...
// import {blue_gradient} from '../utils/hero.css'
...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    ...
    if (form.prompt) {
      try {
        ...
        // https://yes-ai-image-generator.onrender.com/api/v1/dalle
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      setLoading(true);
// yes-ai-image-generator.onrender.com
      try{
...
const blueGradientStyles = {
  ...
  backgroundImage: 'linear-gradient(315deg, #EF6DA0 0%, #EE8E6B 74%)',
  ...
  return (
    ...
    <section className='max-w-7x1 mx-auto'>
      <div>
        <span className="text-lg font-bold" style={{ ...blueGradientStyles, fontSize: '38px' }}>
  Generate Images
</span>
<br className="max-md:hidden" />

        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">Create imaginative and visually stunning images through natural language</p>
      </div>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                   style={{
    borderColor: '#F97316',
    backgroundImage: 'linear-gradient(to bottom right, #20BF55,#01BAEF)',}}
          >
        ...
        <div className="mt-10">
          ...
          <button
            ...
            style={{
    borderColor: '#F97316',
    backgroundImage: 'linear-gradient(to bottom right, #009FFD,#2A2A72)',}}
          >
